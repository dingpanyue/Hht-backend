...
class AcceptedAssignmentService
{
    ...
    {
        $acceptedAssignments = $this->acceptedAssignmentEloqument->with('assignUser')->with('assignment')->where('serve_user_id', $user->id)->orderBy('status', 'asc')->orderBy('updated_at', 'desc');
